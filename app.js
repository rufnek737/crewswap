...
async function renderCouponShop() {
  ...
  if (state.freeEra) {
    box.innerHTML = `
      ...
      <p class="hint">무료 이용 기간에는 <strong>매달 1장</strong>이 자동으로 지급됩니다. 급구에 응해 근무를 내주면 회사 상신이 완료될 때 <strong>0.5장</strong>을 더 받습니다.</p>`;
    return;
  }
  ...
  box.innerHTML = `
    ...
    <p class="hint">급구에 응해 근무를 내주면 회사 상신이 완료될 때 급구 쿠폰 0.5장을 받습니다.</p>`;
