...
function bindEvents() {
  ...
  $("#sendVerifyBtn").addEventListener("click", async () => {
    ...
    try {
      const res = await fetch("/.netlify/functions/send-verify", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  $("#checkVerifyBtn").addEventListener("click", async () => {
    ...
    try {
      const res = await fetch("/.netlify/functions/check-verify", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  $("#ccLoginButton").addEventListener("click", async () => {
    ...
    try {
      const resp = await fetch("/.netlify/functions/crewconnex", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
