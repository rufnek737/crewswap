...
function createMockAlerts() {
  const alerts = [
    { id:"confirm", kind:"announce", title:"⚠️ 스왑은 회사 승인으로 확정됩니다", date:"2026.09.05",
      ...
      time:"공지" },
    { id:"guide", kind:"announce", title:"📢 듀티스왑 사용 안내", date:"2026.08.03",
      ...
      time:"공지" },
    { id:"qna", kind:"announce", title:"❓ 자주 묻는 질문", date:"2026.08.21",
      body:"Q1. 스왑 올리기, 요청하기, 의향 묻기는 어떻게 다른가요?\n내 스왑 올리기는 내가 바꾸고 싶은 근무를 게시하는 기능입니다.\n의향 묻기는 크레딧 사용 없이 상대에게 \"내 근무와 교환할 생각이 있는지\" 먼저 확인하는 기능입니다.\n요청하기는 크레딧을 사용하여 상대가 올린 스케줄에 내 근무를 제안하고, 정식 교환 절차를 진행하는 기능입니다.\n\nQ2. 상대방이 올린 게시글에 내가 교환하려고 하면, 내 스케줄 전체가 상대에게 보이나요?\n아니요. 상대방과 같은 날짜의 스케줄로 바로 바꾸는 1:1 스왑의 경우, 내가 제안한 근무만 보입니다.\n단, 1:1 스왑이 아니거나 날짜가 다르거나, 여러 근무 중 상대가 받을 근무를 직접 골라야 하는 경우에는 그달의 내 근무가 상대방에게 공개될 수 있습니다.\n상대방에게 보여지길 원하지 않는 날짜의 스케줄은 내 스케줄 숨기기로 제외할 수 있습니다.\n\nQ3. 실명, 사번, 연락처는 언제 공개되나요?\n양쪽이 상호 수락한 뒤에만 공개됩니다.\n그전까지는 닉네임, 베이스, 직책 등 기본 공개 정보만 표시됩니다. 공개된 실명, 사번, 연락처는 회사 스왑 진행 목적 외에는 사용할 수 없습니다.\n\nQ4. 규정 경고로 요청할 수 없는 이유는 무엇인가요?\n듀티스왑은 휴식시간, 연속 근무, 모기지 휴무, RSV/STBY 패턴, 자격, 스왑 횟수 등을 자동으로 확인합니다.\n규정에 맞지 않으면 해당 날짜와 사유를 표시하고 요청을 막습니다.\n단, 앱의 규정 확인은 보조 기능이므로 원본 일정과 최신 회사 규정은 반드시 다시 확인해주세요.\n\nQ5. 요청이나 의향을 거절하면 어떤 내용이 전달되나요?\n일반 거절의 경우, 상대방에게 \"개인 사정으로 진행이 어렵다\"는 안내가 전달됩니다.\n자동 규정 확인에서 불가능하다고 판단된 경우에는 개인 사유가 아니라 문제 날짜와 규정 사유가 전달됩니다.\n\nQ6. 상호 수락하면 스왑이 끝난 건가요?\n아닙니다. 상호 수락은 두 이용자의 의사 확인이며 회사 승인이 아닙니다.\n글을 올린 사람이 회사 시스템에 근무교환을 신청하고, 최종 승인 여부를 확인해야 합니다.\n\nQ7. 무료 크레딧은 어떻게 사용되나요?\n무료 이용자는 스왑 글 등록과 정식 요청에 각각 1크레딧을 사용합니다.\n의향 묻기는 무료입니다.\n매월 첫 실행 시 기본 3크레딧이 제공되며, 남은 크레딧은 다음 달로 이월되지 않습니다.\n현재 무료 이용 기간에는 크레딧을 무제한으로 사용할 수 있습니다.\n\nQ8. 취소하거나 마감되면 크레딧이 환급되나요?\n스왑 절차 진행 전 등록을 취소하면 사용한 등록 크레딧이 기본 상한인 3개까지 복원됩니다.\n등록한 글이 매칭 없이 마감되면 사용한 크레딧의 50%가 자동 환급됩니다.\nPRO 무제한 기능으로 등록한 글은 크레딧을 쓰지 않으므로 환급도 없습니다.\n\nQ9. 무료와 PRO는 무엇이 다른가요?\n스왑 검색, 등록, 요청, 수락, 규정 확인 등 핵심 기능은 무료로 사용할 수 있습니다.\nPRO 영구 이용권은 최초 1회만 구매하는 상품입니다.\nPRO 이용자는 원하는 조건의 새 글이 올라오면 앱을 닫은 상태에서도 푸시 알림을 받을 수 있고, 스왑 등록과 정식 요청 크레딧을 무제한으로 사용할 수 있습니다.\n또한 스왑 목록에서 편조구성원 정보를 상호 수락 전에도 미리 확인할 수 있습니다.\n\nQ10. 앱을 닫아도 PRO 알림이 오나요?\n네. 휴대폰 알림 권한과 백그라운드 알림이 켜져 있고, 스왑 게시판에 검색 조건을 저장해두면 앱을 열지 않아도 알림을 받을 수 있습니다.\n다만 기기 설정, 네트워크 상태, 운영체제 정책에 따라 알림이 늦거나 제한될 수 있습니다.\n\nQ11. 스왑 횟수 제한이 있나요?\n객실승무원은 실제 상호 수락된 스왑을 기준으로 월 2회, 연 12회 한도를 확인합니다.\n한도에 도달하면 앱에서 경고하고 진행을 막습니다.\n운항승무원은 현재 앱에서 별도 횟수 제한을 적용하지 않습니다.\n\nQ12. 달력의 👀, ⚠️ 아이콘은 무엇인가요?\n👀 옆 숫자는 다른 사용자가 해당 날짜에 올린 스왑 글 수입니다.\n⚠️는 연속 근무 등 규정상 주의가 필요한 날짜입니다.\n실제 교환 가능 여부는 등록 또는 요청 단계에서 다시 자동 확인됩니다.\n\nQ13. 휴대폰을 바꾸거나 앱을 삭제하면 일정과 크레딧이 복원되나요?\n계정, 프로필, 등록 글, 요청 내역, PRO 정보, 크레딧은 서버 계정에 연결되어 있어 다시 로그인하면 복원됩니다.\nCrewConnex로 불러온 근무표도 서버에 저장되며, 같은 계정으로 로그인하면 다른 기기에서도 동기화됩니다.\n탈퇴하면 서버 정보와 현재 기기 정보가 함께 삭제됩니다.\n\nQ14. 편조구성원은 언제 볼 수 있나요?\nPRO 이용자는 스왑 목록을 볼 때부터 편조구성원을 확인할 수 있습니다.\n무료 사용자는 상호 수락이 끝난 뒤에만 확인할 수 있습니다.\n단, 원본 스케줄에 편조 정보가 없거나 아직 미정인 근무는 PRO에서도 표시되지 않을 수 있습니다.\n\nQ15. 표시된 편조구성원이 실제와 다를 수 있나요?\n네, 다를 수 있습니다.\n편조구성원은 스왑 글을 올리거나 요청을 보낸 시점의 스케줄 정보를 기준으로 표시됩니다. 이후 회사에서 편조를 변경하면 앱에 표시된 내용과 실제 편조가 달라질 수 있습니다.\n스왑을 결정하기 전에는 회사 시스템에서 최신 편조를 반드시 확인해주세요.\n\nQ16. 급구는 무엇인가요?\n급구는 마감이 임박해 빠르게 바꿔야 하는 스왑입니다.\n급구로 올리면 등급과 조건이 맞는 승무원에게 즉시 알림이 갑니다. 글 하나당 급구 쿠폰 1장을 사용합니다.\n급구 쿠폰은 유료 구매 소모품이며, 사용하지 않은 쿠폰은 다음 달로 이월됩니다.\n\nQ17. 급구에 응하면 무엇을 받나요?\n급구에 응한 승무원은 회사 상신이 완료될 때 급구 쿠폰 0.5장을 보상 받습니다.\n급구 쿠폰 1장으로 급구 글을 올릴 수 있으므로, 두 번 도와주면 한 번 급구를 올릴 수 있습니다.\n상호 수락이 아니라 회사 상신 완료를 기준으로 지급됩니다.\n\nQ18. 급구로 올렸는데 매칭이 안 되면 쿠폰은 어떻게 되나요?\n마감일까지 매칭되지 않으면 사용한 급구 쿠폰 1장이 그대로 복구됩니다.\n다만 마감 전에 직접 등록을 취소한 경우에는 복구되지 않습니다.\n\nQ19. 지금은 무엇이 무료인가요?\n출시를 기념해 2027년 9월 30일까지 모든 기능을 무료로 사용할 수 있습니다.\nPRO 기능인 조건 알림, 무제한 크레딧, 편조구성원 미리보기도 별도 구매 없이 사용할 수 있습니다.\n급구 쿠폰은 매달 1장씩 자동 지급됩니다. 이 기간에는 앱 안에 구매 버튼이 표시되지 않습니다.",
      time:"공지" },
  ];
  ...
  // 본문은 위에 확정본으로 둔다. 예전에는 여기서 .replace()로 문구를 덧칠했는데,
  // 찾는 문자열에 뒤 항목까지 딸려 들어가 Q16 이후가 통째로 지워진 적이 있다.
  const qna = alerts.find(item => item.id === "qna");
  if (qna) qna.date = "2026.09.05";
...
const SERVICE_LINKS = Object.freeze({
  ...
  contact: "mailto:info@rufnekcrew.com?subject=듀티스왑%20문의",
});
...
function parseDayBlock(block, codeDescriptions) {
  ...
  if (route && !flight) {
    ...
    // 월 약어(JAN·SEP…)와 요일도 세 글자 대문자라 공항으로 오인된다 — 실제로 9월 지상근무의
    // 장소가 "SEP"으로 저장되고 있었다.
...
function reclassifyGroundDuty(s) {
  ...
  // 훈련 여부는 활동코드에 있다(S_L+U = LOFT+UPRT). title·routeSummary만 보면
  // 코드가 거기 없어서 전부 "지상근무"로 떨어진다 — 실제로 그랬다.
...
function checkRulesCabin(ss, rules) {
  ...
  // 공휴일·주말 제한은 OFFMED 에만 걸린다. 예전에는 공휴일이기만 하면 걸었는데
  // 그런 일반 규정은 어디에도 없다.
  const isWeekendDay = day => [0, 6].includes(dayToDate(day).getDay());
  const blockedHoliday = ss.some(s =>
    String(s.type || "").toUpperCase() === "OFFMED" && (isHoliday(s.day) || isWeekendDay(s.day)));
  ...
  return [
    { label: deadlineLabel,
      ...
      ref: `객실 Swap Guide에 의거 — 스왑 성사 후 회사 시스템에 근무교환 신청서를 변경 시작일의 ${rules.deadline.businessDays}영업일 전까지 제출해야 합니다. 마감 이후에는 회사 접수가 불가합니다.` },
    { label:`연속 근무일 (${consecLimit}일 미만)`,
      status: consecFail ? "FAIL" : consecWarn ? "WARN" : "PASS",
      detail:`최대 ${cum.maxConsec}일`,
      ref: "객실 Swap Guide에 의거 — 7일 이상 연속 근무가 되면 신청 불가(OFF·VAC 제외)." },
    { label:"RSV 다음날 OFF 불가",
      status: rsvNextOff ? "FAIL" : "PASS",
      detail: rsvNextOff ? "RSV 포함 최소 3일 SKD 필요" : "해당 없음",
      ref: "객실 Swap Guide에 의거 — RSV는 패턴 전체(최소 3일)를 함께 변경해야 합니다." },
    { label:"변경 불가 타입 (UV_ML)",
      status: hasUvml ? "FAIL" : "PASS",
      detail: hasUvml ? "UV_ML은 스왑 불가" : "해당 없음",
      ref: "객실 Swap Guide에 의거 — UV_ML 코드가 포함된 스케줄은 변경 불가 대상입니다." },
    { label:"변경 불가 지정 근무",
      status: hasLocked ? "FAIL" : "PASS",
      detail: hasLocked ? "회사 지정 변경 불가 근무 포함" : "해당 없음",
      ref: "회사 지정 변경 불가 근무(예: 특별편, 의전, 훈련 비행 등)는 스왑 대상에서 제외됩니다." },
    { label:"OFFMED 공휴일·주말 변경 불가",
      status: blockedHoliday ? "FAIL" : "PASS",
      detail: blockedHoliday ? "OFFMED — 공휴일·주말로 변경 불가" : "해당 없음",
      ref: "객실 Swap Guide에 의거 — OFFMED는 공휴일·주말로 변경할 수 없습니다." },
    ...
    { label: isPilotUser ? "월 스왑 횟수 (무제한)" : `월 스왑 횟수 (월 ${monthlyLimit}회)`,
      ...
      ref: isPilotUser ? null : "객실 Swap Guide에 의거 — 스왑은 월 2회, 연 12회를 초과할 수 없습니다. 카운트는 스왑이 실제 성사(상호 수락)된 경우에만 증가합니다." },
    ...
    { label: isPilotUser ? "연 스왑 횟수 (무제한)" : `연 스왑 횟수 (연 ${yearlyLimit}회)`,
      ...
      ref: isPilotUser ? null : "객실 Swap Guide에 의거 — 연간 스왑 총 횟수는 12회 한도. 월 한도(2회)와 별도로 적용됩니다." },
    { label:"STBY/RSV 직급 조건",
      ...
      detail: hasStby
        ...
        : "해당 없음",
      ref: "객실 Swap Guide에 의거 — STBY·RSV는 동일·상위 직급과만 교환 가능합니다." },
    { label:"6일 연속 근무 랜딩 시간",
      status:"WARN",
      detail:"6일 연속 근무 시 마지막 날 랜딩 20:00 이전 SKD인지 직접 확인 필요",
      ref: "객실 Swap Guide에 의거 — 연속 6일 근무가 되면 6일차 착륙(STA)이 20:00 이전이어야 합니다." },
    { label:"Base별 신청 가능 시간",
      status:"WARN",
      detail:"전날 복귀(STA) 기준 신청 가능 시간 확인 (예: ICN-ICN STA 22:00 기준 당일 13:00 이후 STD)",
      ref: "객실 Swap Guide에 의거 — Base별 휴식시간 기준표에 따라 전날 도착(STA) 이후 충분히 쉬어야 신청할 수 있습니다." },
    { label:"노선 언어/성별 자격",
      status:"WARN",
 ...
 * 이야기다. 듀티스왑 의 교환은 전부 사람 대 사람이라 여기서는 언제나 양도가 된다.
 *
...
function updateBadges() {
  ...
  if (nickEl) nickEl.textContent = `${state.user.nickname || "듀티스왑"} 님`;
...
function applyCreditWallet(wallet, shouldRender = true) {
  ...
  state.urgentCoupons = Number(wallet.urgentCoupons) || 0;
...
// 급구 쿠폰은 PRO 무제한과 무관한 별도 소모품이라, 잔량과 필요 수를 그대로 보여준다.
function renderUrgentOption(postCount) {
  const box = document.getElementById("postUrgent");
  const note = document.getElementById("postUrgentNote");
  if (!box || !note) return;
  const have = state.urgentCoupons || 0;
  const need = Math.max(1, postCount || 1);
  const enough = have >= need;
  if (!enough) box.checked = false;
  box.disabled = !enough;
  box.closest(".urgent-toggle")?.classList.toggle("is-locked", !enough);
  note.textContent = enough
    ? `등급이 맞는 승무원 전원에게 즉시 알림 · 쿠폰 ${need}장 사용 (보유 ${have}장)`
    : `급구 쿠폰이 없습니다 (필요 ${need}장 · 보유 ${have}장) — 내 정보에서 구매`;
}
...
function renderMatches() {
  ...
  // CAT III 는 규정에서 뺐으므로 필터에도 적지 않는다 — 거르지 않는 것을 걸렀다고 쓰면 안 된다.
  const pilotQualStr = state.user.crewType !== "CABIN"
    ? ` · ${state.user.aircraft==="NG_MAX"?"NG+MAX":"NG"}${state.user.edto?" · EDTO":""}` : "";
...
async function purchaseLifetimePro() {
  ...
  try {
    ...
    showToast('듀티스왑 PRO 영구 이용권이 활성화되었습니다.');
  } catch (error) {
...
async function renderCouponShop() {
  ...
  if (state.freeEra) {
    box.innerHTML = `
      ...
      <p class="hint">무료 이용 기간에는 <strong>매달 1장</strong>이 자동으로 지급됩니다. 급구에 응한 승무원은 회사 상신이 완료될 때 <strong>0.5장</strong>을 보상 받습니다.</p>`;
    return;
  }
  ...
  box.innerHTML = `
    ...
    <p class="hint">급구에 응한 승무원은 회사 상신이 완료될 때 급구 쿠폰 0.5장을 보상 받습니다.</p>`;
...
async function restoreLifetimePro() {
  ...
  try {
    ...
    if (transaction?.status !== 'verified') {
      showToast('복원할 듀티스왑 PRO 구매 내역이 없습니다.');
      return;
    }
    await verifyAndApplyApplePurchase(transaction);
    showToast('듀티스왑 PRO 구매 내역을 복원했습니다.');
  } catch (error) {
...
async function registerNativePushNotifications() {
  ...
  if (permission.receive !== 'granted') throw new Error('설정에서 듀티스왑 알림을 허용해주세요.');
...
async function processExpiredRefunds() {
  ...
  for (const p of state.myPosts) {
    ...
    if (!p.refunded && p.status !== "expired") {
      ...
      p.urgentCouponRefunded = Number(result.couponRefunded) || 0;
      p.refunded = true;
      p.status = "expired";
      refundTotal += refund;
      count++;
    ...
    if (!p.expiredAlerted && (p.refunded || p.status === "expired")) {
      ...
      state.alerts.unshift({
        ...
        goTo: "myPostsManager",
        postId: p.id,
        title: p.urgentCouponRefunded > 0
          ? "⏰ 스왑 마감 · 급구 쿠폰 복구"
          : refund > 0 ? "⏰ 스왑 마감 · 크레딧 환급" : "⏰ 스왑 마감",
        body: p.urgentCouponRefunded > 0
          ? `내가 올린 '${p.offered?.patternName || "스왑"}'이 매칭 없이 마감되어 급구 쿠폰 ${p.urgentCouponRefunded}장을 돌려드렸습니다.${refund > 0 ? ` 크레딧 ${refund}개(50%)도 함께 환급되었습니다.` : ""}`
          : refund > 0
...
function bindEvents() {
  ...
  document.getElementById("withdrawForm")?.addEventListener("submit", async e => {
    ...
    try {
      ...
      closeGenericModal("withdrawDialog", "withdrawOverlay");
      alert("회원 탈퇴가 완료되었습니다. 서버와 이 기기의 듀티스왑 정보가 삭제되었습니다.");
      location.reload();
    } catch (error) {
  ...
  async function doSubmitPost() {
    ...
    // 급구는 묶음(글) 하나당 쿠폰 1장이라, 비연속 선택으로 여러 글이 나뉘면 그만큼 든다.
    const urgent = !!$("#postUrgent")?.checked;
    if (urgent && (state.urgentCoupons || 0) < needed) {
      showToast(`급구 쿠폰 부족 (필요: ${needed}장, 보유: ${state.urgentCoupons || 0}장)`);
      return;
    }
    let createdCount = 0;
...
/* ── 베타 테스트 안내 ────────────────────────────────────────────
   ...
   첫 화면에서 확실히 알린다. '다시 보지 않기'로 접어둘 수 있다.
   정식 출시 때 BETA_NOTICE_ACTIVE만 false로 두면 된다.

   키에 버전을 붙인다. 고정 키를 쓰면 한 번 접은 사람은 안내 내용이 바뀌어도
   새 내용을 영영 못 본다 — 실제로 '베타 안내'를 접어둔 기기에서 지금의
   '회사 승인' 안내가 뜨지 않았다. 문구를 고칠 때는 이 숫자도 함께 올린다. */
const BETA_NOTICE_ACTIVE = true;
const BETA_NOTICE_VERSION = 2;
const BETA_NOTICE_KEY = `crewswap_beta_notice_hidden_v${BETA_NOTICE_VERSION}`;
...
(() => {
  ...
  if (el) el.textContent = `듀티스왑 ${APP_VERSION} · ${APP_RELEASE_DATE}`;
})();
...
console.log('%c🛠️ 듀티스왑 콘솔 헬퍼 활성화', 'background:#F07820;color:#fff;padding:4px 8px;border-radius:4px;font-weight:700;');
