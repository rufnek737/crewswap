...
function renderSavedSearches() {
  ...
  if (addEl) {
    if (atLimit) {
      addEl.innerHTML = `<div class="premium-lock">🔒 무료는 알림 조건 ${FREE_SAVED_SEARCH_LIMIT}개까지 · <strong>프리미엄에서 무제한</strong><br><small>여러 조건(퀵턴/장박/목적지 등)을 저장하려면 프리미엄으로 업그레이드하세요.</small></div>`;
    } else {
      addEl.innerHTML = `
