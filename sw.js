...
const CACHE = 'crewswap-v82';
const SHELL = ['./index.html', './styles.css', './credit-policy.js', './post-dates.js', './schedule-continuity.js', './app.js', './manifest.json', './privacy.html', './terms.html'];
